...
pub enum Exp_ {
    ...
    Block(Sequence),
<<<<<<< HEAD:third_party/move/move-compiler/src/expansion/ast.rs
...
>>>>>>> aptos-node-v1.36.8-hotfix:third_party/move/move-compiler-v2/legacy-move-compiler/src/expansion/ast.rs
    Quant(
        QuantKind,
        LValueWithRangeList,
        Vec<Vec<Exp>>,
