...
use crate::{
    ...
    expansion::{
        ...
        ast::{
<<<<<<< HEAD:third_party/move/move-compiler/src/expansion/translate.rs
...
>>>>>>> aptos-node-v1.36.8-hotfix:third_party/move/move-compiler-v2/legacy-move-compiler/src/expansion/translate.rs
        },
