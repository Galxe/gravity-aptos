...
pub enum Exp_ {
    ...
    // { seq }
    Block(Sequence),
<<<<<<< HEAD:third_party/move/move-compiler/src/parser/ast.rs
    // | x1 [: t1], ..., xn [: tn] | e
    Lambda(TypedBindList, Box<Exp>, LambdaCaptureKind),
=======
    // | x1 [: t1], ..., xn [: tn] | e [ spec ]
    Lambda(TypedBindList, Box<Exp>, LambdaCaptureKind, Option<Box<Exp>>),
>>>>>>> aptos-node-v1.36.8-hotfix:third_party/move/move-compiler-v2/legacy-move-compiler/src/parser/ast.rs
