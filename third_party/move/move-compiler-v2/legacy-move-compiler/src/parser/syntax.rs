...
//       LambdaRest =
<<<<<<< HEAD:third_party/move/move-compiler/src/parser/syntax.rs
//                      <LambdaBindList> <Exp>
=======
//                      <LambdaBindList> <Exp> [<SpecBlock>]
>>>>>>> aptos-node-v1.36.8-hotfix:third_party/move/move-compiler-v2/legacy-move-compiler/src/parser/syntax.rs
fn parse_lambda(
    context: &mut Context,
    start_loc: usize,
...
=======
    ...
    Ok(Exp_::Lambda(bindings, body, capture_kind, spec_opt))
>>>>>>> aptos-node-v1.36.8-hotfix:third_party/move/move-compiler-v2/legacy-move-compiler/src/parser/syntax.rs
}
