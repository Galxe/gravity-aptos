...
pub fn aptos_prod_vm_config(
    ...
    if timed_features.is_enabled(TimedFeatureFlag::_LimitTypeTagSize) {
    ...
    let use_compatibility_checker_v2 = verifier_config.enable_enum_types
        || features.is_enabled(FeatureFlag::_USE_COMPATIBILITY_CHECKER_V2);
    ...
    VMConfig {
        ...
        ty_builder,
        disallow_dispatch_for_native: features.is_enabled(FeatureFlag::_DISALLOW_USER_NATIVES),
